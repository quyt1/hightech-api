 ...
 */
 ...
 const adminEmail = 'quyt.dev@gmail.com'
 const adminPassword = 'sqrkekkdqajwiqle'
 ...
 const sendMail = (params) => {
   ...
   const options = {
     ...
     subject: params.subject, // Tiêu đề của mail
     html: params.htmlContent // Phần nội dung mail mình sẽ dùng html thay vì thuần văn bản thông thường.
   }
